...
public interface StatsRepository extends  JpaRepository<Hit, Long> {
    @Query("select new ru.practicum.statistics_dto.HitOutcomeDto(h.app, h.uri, count(h.id)) from Hit as h " +
    ...
    @Query("select new ru.practicum.statistics_dto.HitOutcomeDto(h.app, h.uri, count(distinct(h.ip))) from Hit as h " +
